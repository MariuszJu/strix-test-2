...
class FileReader
{
     ...
     * @return $this
     */
    public function init(string $filePath, string $mode = 'a+', bool $createDirectory = true)
    {
        if ($createDirectory) {
     ...
     * @return array
     */
    public function readLocation(string $path)
    {
        $entries = [];
     ...
     * @return self
     */
    public function writeLine(string $line, bool $withNewLine = true)
    {
